...
var $author$project$Main$Model = F2(
	function (index, slides) {
		return {index: index, slides: slides};
	});
var $elm$core$String$trim = _String_trim;
var $author$project$Main$handleHttp = function (msg) {
	switch (msg.$) {
		case 'Loading':
			return A2(
		...
		case 'Success':
			...
			return A2(
				...
				A2(
					...
					'---',
					$elm$core$String$trim(slides)));
		default:
			return A2(
				$author$project$Main$Model,
				1,
				_List_fromArray(
					['Couldn\'t Load Slides (ᵕ—ᴗ—)']));
	}
};
var $author$project$Main$url = 'http://localhost:6969/slides';
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		$author$project$Main$handleHttp($author$project$Main$Loading),
		$elm$http$Http$get(
			{
	...
	function (msg, model) {
		if (msg.$ === 'GotResponse') {
			...
			if (result.$ === 'Ok') {
				...
				return _Utils_Tuple2(
					$author$project$Main$handleHttp(
						$author$project$Main$Success(content)),
					$elm$core$Platform$Cmd$none);
			} else {
				return _Utils_Tuple2(
					$author$project$Main$handleHttp($author$project$Main$Failure),
					$elm$core$Platform$Cmd$none);
			}
		} else {
			var keyCode = msg.a;
